...
namespace Sandbox
{
    ...
    ""controlSchemes"": [
        ...
        ~@CaseGamepadStretchControls()
        {
            Debug.Assert(!m_PlayerBaseControls.enabled, "This will cause a leak and performance issues, CaseGamepadStretchControls.PlayerBaseControls.Disable() has not been called.");
        }
        ...
        private List<IPlayerBaseControlsActions> m_PlayerBaseControlsActionsCallbackInterfaces = new List<IPlayerBaseControlsActions>();
        ...
        public struct PlayerBaseControlsActions
        {
            ...
            public void AddCallbacks(IPlayerBaseControlsActions instance)
            {
                if (instance == null || m_Wrapper.m_PlayerBaseControlsActionsCallbackInterfaces.Contains(instance)) return;
                m_Wrapper.m_PlayerBaseControlsActionsCallbackInterfaces.Add(instance);
            ...
            private void UnregisterCallbacks(IPlayerBaseControlsActions instance)
            {
                @TimeStopHold.started -= instance.OnTimeStopHold;
                @TimeStopHold.performed -= instance.OnTimeStopHold;
                @TimeStopHold.canceled -= instance.OnTimeStopHold;
            ...
            public void RemoveCallbacks(IPlayerBaseControlsActions instance)
            {
                if (m_Wrapper.m_PlayerBaseControlsActionsCallbackInterfaces.Remove(instance))
                    UnregisterCallbacks(instance);
            }

            public void SetCallbacks(IPlayerBaseControlsActions instance)
            {
                foreach (var item in m_Wrapper.m_PlayerBaseControlsActionsCallbackInterfaces)
                    UnregisterCallbacks(item);
                m_Wrapper.m_PlayerBaseControlsActionsCallbackInterfaces.Clear();
